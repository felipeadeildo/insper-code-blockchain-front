  ...
  return (
    <ChakraProvider>
      ...
      <Routes>
        ...
        <Route path="/learn/curso-intro/introducao" exact element={<Introducao />} />
        <Route path="/learn/curso-intro/bitcoin" exact element={<Bitcoin />} />
        <Route path="/learn/curso-intro/blockchain" exact element={<Blockchain />} />
        <Route path="/learn/curso-intro/crypto-assets" exact element={<CryptoAssets />} />
        <Route path="/learn/curso-intro/chains" exact element={<Chains />} />
        <Route path="/learn/curso-intro/tecnologia" exact element={<Tecnologia />} />
